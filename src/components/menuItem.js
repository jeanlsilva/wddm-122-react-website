function MenuItem(props) {
    return (
        <div className="bg-white rounded-xl flex flex-col items-center justify-between px-4 hover:bg-gray-300 transition-all ease-in-out duration-500 cursor-pointer">
