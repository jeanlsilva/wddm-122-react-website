...
function BestChoices() {
    return (
        <section id="3" className="h-screen flex flex-col bg-choices bg-cover justify-center px-24">
            <div className="relative z-20">
                <h2 className="text-5xl font-bold text-center mb-12 text-green-900">This is our top 3</h2>
